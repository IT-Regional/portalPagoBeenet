    ...
    <main class="main-wrapper">
      ...
      <section class="section">
        ...
        <div class="card-style text-center"
          style="background-image: url('{{ asset('images/banner-beenet.png') }}'); background-repeat: no-repeat; background-size: cover; height:500px;">
          <div class="error-box" style="margin-top: 20%;">
            <h1 class="fw-700 mb-15 text-white">Beenet</h1>
            <h6 class="mb-10 text-white">Dejaremos tu nuevo hogar u oficina lista con Internet de máxima velocidad.</h6>
          </div>
        </div>
